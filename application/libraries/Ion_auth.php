...
class Ion_auth
{
	...
	/**
	 * @return int|null The user's type from the session user data or NULL if not found
	 * @author jrmadsen67
	 **/
	...
	public function loggedUserType($email)
	{
		$user_type = $this->ion_auth_model->getUserType($email);
		if (!empty($user_type))
		{
			return $user_type;
		}
