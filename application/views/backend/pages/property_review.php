													...
													<div class="form-group">
														...
														<select name="seller_id" id="seller_id">
															...
															foreach ($sellers as $seller_account) {
																echo '<option value="'.$seller_account['id'].'" '.(($property['seller_id'] == $seller_account['seller_id'])? 'selected':'').'>'.$seller_account['first_name'].' '.$seller_account['last_name'].' </option>';
															}
															?>
														</select>
													</div>
															...
															<div class="form-group row">
																...
																<div class="col-lg-12">
																	<div class="input-group">
																		...
																		<span class="input-group-append">
																		<span class="input-group-text inputsetType"><?php echo $property['property_type'];?></span>
																		</span>
																	</div>
																	<div class="error"></div>
