...
<form method="POST" class="couponform w-100" data-source="formajaxurl" style="margin-top:-9px;">
    <div class="card" id="couponaddpart">
        <div class="card-header header-elements-inline">
            <h3 class="card-title"><span class="icon-co-big orange coupon"></span> Premium Search Query </h3>
        </div>
        <div class="card-body">
            <div class="row">
                        ...
                        <div class="col-md-6 col-xl-6 offset-md-3 offset-xl-3">
                            <div class="card  border-0 rounded-0 shadow-sm minHeight mb-4">
                                <h1 class="text-center font-weight-bold text-white mb-0 py-1"
                                    style="font-size: 23px; background-color: #00c48d;">Premium Search Query
                                </h1>
...
//                                                ?>
                                ...
                                <div class="row my-3">
                                    <div class="col-sm-12">
                                        <a href="javascript:void(0);" class="btn btn-primary btn-lg btn-block" data-orderId="<?= $order_id ?>"
