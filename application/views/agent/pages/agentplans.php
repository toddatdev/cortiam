										...
										<div class="col-sm-4">
											<div class="card bg-warning border-0 rounded-0 shadow" style="min-height: 500px !important;">
												<div class="card-header text-center text-white border-0 py-1">
														...
														<h1 class="text-center font-weight-bold text-white mb-0" style="font-size: 34px"><sub>$<?= getPlanPrice($plan['id']) ?></sub></h1>
														<p><?= $plan['details'] ?></p>
												</div>
											...
											<div class="row">
												<div class="col-sm-12">
													<div class="form-group">
														...
														<input class="form-control" type="text" readonly name="coupon" id="Coupon" value="" />
