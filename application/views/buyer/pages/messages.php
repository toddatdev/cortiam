	<div class="card">
	  ...
	  <div class="card-body" id="buyerScrollableDiv"  style="max-height: 500px !important; overflow-y: scroll">
			<ul class="media-list media-chat mb-3 pl-0">
                <?php
                if ($messages) {
                    foreach ($messages as $message) {

                        if ($message['msg_to'] == 'Buyer') {
                            ...
                            echo '<li class="media">
											<div class="mr-3">
												<img src="' . (($message['agent_image']) ? $imageFound : base_url('images/userphoto_mini.jpg')) . '" class="rounded-circle" width="40" height="40" alt="' . $message['seller'] . '">
											</div>
                            ...
                            $imageFound = base_url(str_replace(".jpg", "_mini.jpg", $message['buyer_image']));
                            $image_type_check = @exif_imagetype($imageFound);
                            if ($image_type_check == false) {
