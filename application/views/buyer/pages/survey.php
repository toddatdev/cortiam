...
<div class="card mb-5 " style="border: 0px !important;">
    <div class="card-header header-elements-inline notehistory">
        ...
        <div class="header-elements d-flex justify-content-between align-items-center">
            <h3 class="card-title mb-0"><span class="icon-co-big orange profile"></span>Customer Survey</h3>
            <a href="javascript:void(0);" class="logout-btn rounded-sm"  id="survyskip">Skip</a>
        </div>
    </div>
    <div class="card-body p-0">
        ...
        <div class="">
            ...
            <form action="<?= base_url('customer/survey-submit') ?>" method="post" id="">
                ...
                <div class="card mb-3 shadow-none" style="border: 0px !important;">
                    ...
                    if (isset($questions) && count($questions) > 0) {
                        ...
                        foreach ($questions as $key => $dt) {
                            $question_choices = getAllQuestionChoices($dt['id']);
                    ...
                    <button class="btn btn-warning mt-3" type="submit">Submit Answer</button>
                    </div>
                </div>
            </form>
