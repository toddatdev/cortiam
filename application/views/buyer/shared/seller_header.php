			...
			<div class="container">
			  <div class="row align-items-center">
			    ...
			    <div class="col-10 col-md-9 white-bg text-right">
						...
						<a href="<?php echo base_url('buyer/tutorials');?>" class="icon-co-sm hat mr-3" data-display="tooltip" data-placement="left" title="Click to view tutorials"></a>
						<a href="<?php echo base_url('buyer');?>" class="icon-co-sm envelope mr-3" data-display="tooltip" data-placement="left" title="Your Messages" role="button" id="latestmsg" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo (($count_pms = count($pms))? '<span class="badge orange-bg bubble animated flash">'.$count_pms.'</span>':'');?></a>
						...
						<a href="<?php echo base_url('seller');?>#" class="icon-co-sm bell mr-3" role="button" id="latestnotify" data-display="tooltip" data-placement="left" title="Your Notifications" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo (($count_usno = (count($usnos) + count($usnots)))? '<span class="badge orange-bg bubble animated flash">'.$count_usno.'</span>':'');?></a>
						  <div class="dropdown-menu links dropdown-menu-right" aria-labelledby="latestnotify">
							  ...
							  <div class="dropdown-item text-center add-border">
								  <a href="<?php echo base_url('buyer/notifications');?>">View All Notifications</a>
							  </div>
							</div>
						</div>
						<div class="dropdown d-inline">
...
<!--							<img class="img-fluid rounded-circle user-avatar" src="--><?php //echo (($account['avatar_string'])? $imageFound :base_url('assets/images/backend/userphoto.jpg'));?><!--" width="46" height="46" role="button" id="useravatarsmall" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">-->
                            <div class="displayName text-uppercase" role="button" id="useravatarsmall" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?= $account['first_name'][0] . $account['last_name'][0] ?></div>
                    ...
                    <div class="col-12 col-lg-3">
                        <div>
                            ...
                            <div class="btn-group w-100" role="group" aria-label="Basic example">
                                <a type="button" class="btn font-weight-bolder change-color" href="<?php echo cortiam_base_url('switch');?>" style="background-color: #fff;color: #4c525e">Selling House</a>
                                <a type="button" class="btn font-weight-bolder active ml-2" href="javascript:void(0);" style="border-left: 6px solid #002C77 !important;background-color: #002c7708 !important;color: #002C77 !important;">Buying House</a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-lg-9">
                        <div class="px-3 d-block d-sm-flex justify-content-between align-items-center question-dropdown">
                            ...
                            <div class="d-flex justify-content-start justify-content-sm-end align-items-center">
                                ...
                                <p class="mt-1" style="color: #00C48D">Buyer Email Notification</p>
                                <label class="switchbutton ml-2 mb-1">

                                    <input type="checkbox" name="notifications" id="buyerNotifications"
                                        <?php
...
<!--						  <a class="nav-link pl-4 --><?php //echo (($header_data['current_menu'] == 'switch')? 'active':'');?><!--" href="--><?php //echo cortiam_base_url('switch');?><!--"> Switch to Seller</a>		  -->
