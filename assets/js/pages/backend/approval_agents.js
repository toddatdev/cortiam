  ...
  ourdatatable = jQuery('#accountstable').DataTable({
	  ...
	  lengthMenu  : [ 10, 25, 50, 75, 100 ],
	    ...
	    "rowId":function(a) {
			...
			"columnDefs": [
			  { "type": "string", "targets": 0, "data": "avatar_string", "title": "", "width": "80px"},
	  ...
	  ajax: {
		  ...
		  type: 'POST',
		  data: function (d) {
			  d.start_date = jQuery("input[name='start_date']" ).val();
			  d.end_date = jQuery("input[name='end_date']" ).val();
			  d.approval = jQuery("select[name='approval']" ).val();
			  d.state = jQuery("select[name='state']" ).val();
			  d.order = jQuery("input[name='order']" ).val();
		  }
	  },
	  columns: [
		  {data: 'avatar_string', name: 'avatar_string'},
		  {data: 'fullname', name: 'fullname'},
		  {data: 'phone', name: 'phone'},
		  {data: 'email', name: 'email'},
		  {data: 'location', name: 'location'},
		  {data: 'brokerage', name: 'brokerage' },
