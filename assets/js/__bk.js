        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                jQuery.ajax({
                    ...
                    success: function (response) {
                        $('#selected_days').val("");
                        $('#selected_days').val(response);
                        console.log($('#selected_days').val());
                    }
                })
            }
...
jQuery(document).on("change", '#notifications', function (ev) {
    ...
    if(notify == true)
    {
        ...
        swal.fire({
            title: 'Please Confirm!',
            showCancelButton: true,
            html: 'Enabling email notifications you will receive emails and impact your ability to win properties. Are you so you want to proceed email notifications?',
            type: "question",
            cancelButtonText: '<b><i class="icon-cross2"></i></b> Cancel',
            cancelButtonClass: "button-dark float-left",
            confirmButtonText: '<b><i class="icon-checkmark3"></i></b> Proceed',
